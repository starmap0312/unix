...
# debugging (with Intelij breakpoints) a sbt project when the project is a single process
  ...
  1) at intellij -> Edit Configurations ..., add a sbt Task configuration 
       + sbt Task (ex. Name = "run server", with Tasks = "run")

# debugging (with Intelij breakpoints) a sbt project when the project runs in a forked process
